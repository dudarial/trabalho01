...
> O sisitema proposto para o "remedmex" terá salvo em seus bancos e dados as informações dos usuários para cadastro, que ficarão registradas em cada conta, assim como seu loguin e senha. Juntamente a essas informações, o usário também irá informar outros dados, como por exemplo, se possui alergia a alguma medicação, idade, sexo, se faz uso de alguma medicação recorrente e se possui alguma doença crônica. O sistema terá que armazenar bancos de dados de sintomas das doenças da região, se há ocorrência de epidemias na região                                                                      
